//1.Declara una variable nombre de tipo string y asígnale un valor.
let nombre:String="Yisel lorena";
console.log(nombre);


//2.Crea una variable edad de tipo number e inicialízala con tu edad.
let edad:number=18;

//3.Declara una variable esEstudiante de tipo boolean y asígnale true.
let esEstudiante:boolean=true;

//4.Crea una función doblarNumero que reciba un number y retorne su doble.
function doblarNumero(a:number):number{
    return a*2;
}

//5.Crea una función concatenarPalabras que reciba dos string y los una en una sola frase.
function concatenarPalabras(una:string,dos:string):string{
    return `${una} ${dos}`;
}

//6.Crea una función esPar que reciba un número y retorne true si es par.
function esPar(numero:number):boolean{
    return numero%2===0;
}

//7.Escribe una función evaluarEdad que reciba una edad y retorne un mensaje según la condición: &quot;Menor de edad&quot; (&lt;18), &quot;Adulto&quot; (&gt;=18).
...
//8.Crea una función compararNumeros que reciba dos números y retorne el mayor.
...
//9.Escribe una función que determine si un número es múltiplo de 5.
function multiplo(numero:number){
    return numero*5===0?"es multiplo de 5":"no es multiplo de 5";
}
console.log(multiplo(10));

//10.Crea una función diaDeLaSemana que reciba un número del 1 al 7 y retorne el nombre del día correspondiente.
...
//11.Crea una función imprimirNumeros que reciba un número y muestre en consola los números del 1 hasta ese número.
...
//12.Escribe una función sumarNumeros que reciba un número n y sume todos los números desde 1 hasta n.
...
//13.Dado un array [3, 6, 9, 12], usa un for para multiplicar cada elemento por 2 y mostrarlo.
...
//14.Crea una función que reciba un array de números y retorne cuántos son mayores a 10.
...
//15.Crea una función que reciba un array y devuelva el número más grande del mismo.
...
//16.Crea una función buscarElemento que reciba un array de numbers y un número, y devuelva true si el número está en el array.
...
//17.Dado un array [&quot;manzana&quot;, &quot;banana&quot;, &quot;uva&quot;, &quot;pera&quot;], usa .map() para convertirlo en mayúsculas.
...
const strings = ["hola", "lorena", "hola", "lorena", "lorena"];
console.log(contarElementos(strings)); 
...
console.log(sumarValores(objetos));
